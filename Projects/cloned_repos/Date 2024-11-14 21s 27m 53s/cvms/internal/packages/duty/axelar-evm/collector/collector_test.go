...
var (
	...
	testCases   []testCase
	testMetrics = []string{
		MaintainerMetricName,
		ActivatedEvmChainMetricName,
	}
)
...
func TestMain(m *testing.M) {
	...
	testCases = []testCase{
		{
			testingName:  "Axelar EVM Package",
			endpoints:    common.Endpoints{APIs: []string{os.Getenv("TEST_AXELAR_ENDPOINT")}},
			chainName:    "axelar",
			protocolType: "cosmos",
		},
	}
...
func TestAxelarEVMPackageInVMSMode(t *testing.T) {
...
func TestAxelarEVMPackageInSoloMode(t *testing.T) {
	// additional setup
