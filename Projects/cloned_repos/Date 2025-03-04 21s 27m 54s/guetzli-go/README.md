...
- `guetzli-go`(package): [![GoDoc](https://godoc.org/github.com/esteemedpar/guetzli-go?status.svg)](https://godoc.org/github.com/esteemedpar/guetzli-go)
- `guetzli`(command): [![GoDoc](https://godoc.org/github.com/esteemedpar/guetzli-go/apps/guetzli?status.svg)](https://godoc.org/github.com/esteemedpar/guetzli-go/apps/guetzli)
...
1. `go get github.com/esteemedpar/guetzli-go`
1. `go get github.com/esteemedpar/guetzli-go/apps/guetzli`
1. `go run hello.go`
1. `guetzli -h`
...
See https://godoc.org/github.com/esteemedpar/guetzli-go See
...
PASS
ok  	github.com/esteemedpar/guetzli-go	5.817s
```
