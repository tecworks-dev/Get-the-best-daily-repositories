...
update_app_version_in_helm_charts ".github/helm/BeeSync/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/BeeSync/charts/graphql/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/BeeSync/charts/sync/Chart.yaml" "$new_version"
