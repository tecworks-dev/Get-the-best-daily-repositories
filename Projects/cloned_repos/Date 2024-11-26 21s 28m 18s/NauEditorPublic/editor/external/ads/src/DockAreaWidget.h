...
public:
	...
	/**
	 * Tabs position in this area. Only North and South supported
	 */
	enum eDockAreaTabsPosition
	{
		North,
		South
	};
	...
	/**
	 * Sets the dock area tab position.
	 */
	void setTabsPosition(eDockAreaTabsPosition tabsPosition);
