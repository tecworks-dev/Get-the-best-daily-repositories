...
#define MEM_K1_TO_PHYSICAL(x) (void*)((ULONG)(x)-0x60000000)
#define MEM_PHYSICAL_TO_K1(x) (void*)((ULONG)(x)+0x60000000)
#define MEM_VIRTUAL_TO_PHYSICAL(x) (void*)((ULONG)(x)&0x1FFFFFFF)
