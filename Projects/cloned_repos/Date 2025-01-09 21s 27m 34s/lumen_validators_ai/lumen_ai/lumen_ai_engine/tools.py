...
from astra_ai_hub.utils import RepositoryNotFoundError
...
def setup_default_tools():
    default_tools = {}
    main_module = importlib.import_module("astra_ai")
...
class Tool:
    ...
    def save(self, output_dir):
        ...
        with open(app_file, "w", encoding="utf-8") as f:
            f.write(
                textwrap.dedent(f"""
            from astra_ai import launch_gradio_demo
            from typing import Optional
    ...
    def push_to_hub(
        ...
        Parameters:
            ...
            token (`bool` or `str`, *optional*):
                ...
                when running `astra_ai-cli login` (stored in `~/.astra_ai`).
        ...
        **kwargs,
        ...
        Args:
            ...
            token (`str`, *optional*):
                ...
                `astra_ai-cli login` (stored in `~/.astra_ai`).
...
def load_tool(
    ...
    **kwargs,
    ...
    Args:
        ...
        token (`str`, *optional*):
            The token to identify you on hf.co. If unset, will use the token generated when running `astra_ai-cli
            login` (stored in `~/.astra_ai`).
...
class ToolCollection:
    ...
    >>> image_tool_collection = ToolCollection(collection_slug="astra_ai-tools/diffusion-tools-6630bb19a942c2306a2cdb6f")
...
class PipelineTool(Tool):
    ...
    Args:
        ...
        token (`str`, *optional*):
            ...
            running `astra_ai-cli login` (stored in `~/.astra_ai`).
