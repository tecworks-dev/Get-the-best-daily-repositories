...
from astracommon.models.authenticated_peer_info import AuthenticatedPeerInfo

from astracommon.utils.stats.memory_statistics_service import memory_statistics
from astragateway.services.block_queuing_service_manager import BlockQueuingServiceManager
...
from astracommon.feed.new_block_feed import NewBlockFeed
...
from astracommon.models.blockchain_network_model import BlockchainNetworkModel
from astracommon.models.blockchain_peer_info import BlockchainPeerInfo
from astracommon.models.node_event_model import NodeEventType
...
from astracommon.network.network_direction import NetworkDirection
from astracommon.network.peer_info import ConnectionPeerInfo
from astracommon.services import sdn_http_service
from astracommon.services.broadcast_service import BroadcastService
from astracommon.storage.block_encrypted_cache import BlockEncryptedCache
from astracommon.utils import network_latency, memory_utils, convert, node_cache
from astracommon.utils.alarm_queue import AlarmId
from astracommon.utils.expiring_dict import ExpiringDict
from astracommon.utils.expiring_set import ExpiringSet
from astracommon.utils.object_hash import Sha256Hash
from astracommon.utils.stats import hooks
...
from astragateway.abstract_message_converter import AbstractMessageConverter
...
from astragateway.services.gateway_broadcast_service import GatewayBroadcastService
...
from astragateway.utils.blockchain_message_queue import BlockchainMessageQueue
...
from astrautils.ssl.extensions import extensions_factory
from astrautils.ssl.ssl_certificate_type import SSLCertificateType
...
class AbstractGatewayNode(AbstractNode, metaclass=ABCMeta):
    """
    astra gateway node. Middlemans messages between blockchain nodes and the astra
    relay network.
    """
    ...
    def send_request_for_remote_blockchain_peer(self):
        """
        Requests a astra owned blockchain node from the SDN.
        """
    ...
    def _get_all_peers(self) -> Set[OutboundPeerModel]:
        peers = self.peer_gateways.union(self.peer_relays)
        transaction_streamer_peer = self.transaction_streamer_peer
    ...
    def _register_potential_relay_peers(self, best_relay_peers: List[OutboundPeerModel]) -> None:
        ...
        for relay in best_relay_set:
            if relay.node_type == NodeType.RELAY_TRANSACTION or relay.node_type == NodeType.RELAY_BLOCK:
                relay.node_type = NodeType.RELAY
