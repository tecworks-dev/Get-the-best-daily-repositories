...
from astracommon.test_utils.mocks.mock_astra_messages import hello_message
...
from astragateway.testing.mocks.mock_btc_messages import btc_version_message
