...
from astracommon.utils.blockchain_utils.btc.btc_object_hash import Sha256Hash, BtcObjectHash
from astracommon.utils.object_encoder import ObjectEncoder
...
from astragateway.messages.btc import btc_normal_message_converter
...
class BtcExtensionMessageConverter(AbstractBtcMessageConverter):
    ...
    def block_to_astra_block(
        ...
        astra_block = tsk.astra_block()
        block = memoryview(astra_block)
    ...
    def astra_block_to_block(self, astra_block_msg, tx_service) -> BlockDecompressionResult:
        ...
        tsk.init(tpe.InputBytes(astra_block_msg), tx_service.proxy)
        try:
            task_pool_proxy.run_task(tsk)
        except tpe.AggregatedException as e:
            self.decompression_tasks.return_task(tsk)
            header_info = btc_normal_message_converter.parse_astra_block_header(astra_block_msg, deque())
    ...
    # pyre-fixme[14]: `compact_block_to_astra_block` overrides method defined in
    ...
    def compact_block_to_astra_block(
        ...
        if success:
            ...
            return self._extension_recovered_compact_block_to_astra_block(result, recovered_item)
        else:
    ...
    def recovered_compact_block_to_astra_block(  # pyre-ignore
            self,
        ...
        return self._extension_recovered_compact_block_to_astra_block(
    ...
    def _extension_recovered_compact_block_to_astra_block(
        self,
        ...
        astra_block = memoryview(compression_task.astra_block())
