...
from astracommon.models.tx_validation_status import TxValidationStatus
from astracommon.services.transaction_service import TransactionService, TransactionCacheKeyType, wrap_sha256, \
    TransactionFromBdnGatewayProcessingResult
from astracommon.utils.blockchain_utils import transaction_validation
...
class GatewayTransactionService(TransactionService):
    ...
    def process_transactions_message_from_node(
        ...
        # avoid filtering low fee transactions in tx_to_astra_txs to match extensions behavior
        astra_tx_messages = message_converter.tx_to_astra_txs(
        ...
        for astra_tx_message, tx_hash, tx_bytes in astra_tx_messages:
            ...
            result.append(
                ProcessTransactionMessageFromNodeResult(
                    tx_seen_flag, tx_hash, tx_bytes, astra_tx_message, tx_validation_status
                )
            )
