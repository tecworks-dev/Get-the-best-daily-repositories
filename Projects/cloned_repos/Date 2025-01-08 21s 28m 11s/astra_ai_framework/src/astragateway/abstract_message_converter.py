...
from astracommon.utils.object_hash import Sha256Hash, convert
from astracommon.utils.memory_utils import SpecialMemoryProperties, SpecialTuple
...
class AbstractMessageConverter(SpecialMemoryProperties, metaclass=ABCMeta):
    ...
    def bdn_tx_to_astra_tx(
        ...
        """
        Convert a raw transaction which arrived from an RPC request into astra transaction.
