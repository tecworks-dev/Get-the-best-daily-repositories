...
from astragateway.connections.eth.eth_node_connection_protocol import EthNodeConnectionProtocol
...
class GatewayTransactionStatsServiceTest(AbstractTestCase):
    ...
    def setUp(self):
        ...
        self.blockchain_connection2 = EthNodeConnection(
        ...
        self.blockchain_connection_protocol = EthNodeConnectionProtocol(
            self.blockchain_connection, is_handshake_initiator, rlpx_cipher
        )
        ...
        self.blockchain_connection_protocol2 = EthNodeConnectionProtocol(
            self.blockchain_connection2, is_handshake_initiator, rlpx_cipher
        )
    ...
    def test_tx_stats_new_full_relay_duplicate_blockchain_node(self):
        ...
        astra_tx_message = self.node.message_converter.tx_to_astra_txs(blockchain_node_tx_msg, 1)
        for (msg, tx_hash, tx_bytes) in astra_tx_message:
