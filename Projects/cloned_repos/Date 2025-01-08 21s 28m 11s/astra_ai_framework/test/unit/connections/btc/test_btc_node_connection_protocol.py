...
from astragateway.btc_constants import NODE_WITNESS_SERVICE_FLAG, BTC_SHA_HASH_LEN
...
from astragateway.messages.btc.inventory_btc_message import InvBtcMessage, InventoryType, GetDataBtcMessage
