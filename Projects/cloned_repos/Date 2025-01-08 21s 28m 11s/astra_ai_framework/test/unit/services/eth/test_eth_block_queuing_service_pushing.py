...
from astragateway.gateway_constants import LOCALHOST
...
from astragateway.services.eth.eth_block_queuing_service import EthBlockQueuingService, EthBlockInfo
