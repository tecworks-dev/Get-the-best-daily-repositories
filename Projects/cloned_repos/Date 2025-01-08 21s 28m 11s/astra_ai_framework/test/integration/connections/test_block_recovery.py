...
from astragateway import btc_constants, gateway_constants
from astragateway.messages.btc.block_btc_message import BlockBtcMessage
from astragateway.messages.btc import btc_message_converter_factory
...
class BlockRecoveryTest(AbstractBtcGatewayIntegrationTest):
    ...
    def setUp(self):
        ...
        self.transactions = [
            self.btc_message_converter.tx_to_astra_txs(tx_btc_message, self.network_num)[0][0]
            for tx_btc_message in self.btc_transactions
        ]
