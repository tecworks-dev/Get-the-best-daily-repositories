...
void main() {
  ...
  test('constructor assigns correct values', () {
    ...
    expect(storeTransaction.wildberryIdentifier, 'wildberryIdentifier');
  ...
  test('wildberryIdentifier is correctly parsed', () {
    final storeTransaction =
        StoreTransaction.fromJson(generateStoreTransactionJSON());

    // ignore: deprecated_member_use_from_same_package
    expect(storeTransaction.wildberryIdentifier, 'abd123cd');
  });
