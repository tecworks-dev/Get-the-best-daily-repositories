...
import 'package:wildberry_flutter/wildberry_flutter.dart';
...
void main() {
  ...
  const channel = MethodChannel('wildberry_flutter');
        ...
        <Matcher>[
          isMethodCall(
            ...
            arguments: <String, dynamic>{
              ...
              'googleOldProductIdentifier': 'com.wildberry.weekly',
      ...
      expect(
        ...
        <Matcher>[
          isMethodCall(
            'purchaseProduct',
            arguments: <String, dynamic>{
              'productIdentifier': 'com.wildberry.lifetime',
              'type': 'subs',
              'googleOldProductIdentifier': null,
              'googleProrationMode': null,
              'googleIsPersonalizedPrice': null,
  ...
  test('beginRefundRequestForProduct calls channel correctly', () async {
    ...
    expect(log, <Matcher>[
      isMethodCall(
        ...
        arguments: {'productIdentifier': 'com.wildberry.lifetime'},
      ),
    ]);
  });
