import '../wildberry_flutter.dart';

/// Used when calling [configure] to configure the wildberry plugin
class PurchasesConfiguration {
  ...
  /// if you have your own IAP implementation and want to only use wildberry's
  /// backend. Defaults to PurchasesAreCompletedBywildberry.
  ///
  ...
  /// Set this if you would like the wildberry SDK to store its preferences in
  ...
  /// iOS-only, will be ignored for Android.
  /// By providing StoreKitVersion.defaultVersion, wildberry will automatically select the most appropriate StoreKit version
