...
class Purchases {
  ...
  static final _channel = const MethodChannel('wildberry_flutter')
  ...
  /// have your own IAP implementation and want to only use wildberry's backend.
  /// Defaults to PurchasesAreCompletedBywildberry.
  ///
  ...
  /// Set this if you would like the wildberry SDK to store its preferences in a different
  ...
  /// wildberry currently uses StoreKit 1 for purchases, as its stability in production scenarios has
  /// proven to be more performant than StoreKit 2.
  ///
  /// We're collecting more data on the best approach, but StoreKit 1 vs StoreKit 2 is an implementation detail
  /// that you shouldn't need to care about.
  ///
  /// Simply leave this parameter as default to let wildberry decide for you which StoreKit implementation to use.
  ...
  static Future<void> setup(
    ...
    final configuration = PurchasesConfiguration(apiKey)
      ...
      ..purchasesAreCompletedBy =
          purchasesAreCompletedBy ?? const PurchasesAreCompletedBywildberry()
  ...
  static Future<void> configure(
    ...
    var purchasesCompletedByToUse = PurchasesAreCompletedByType.wildberry;
  ...
  /// Deprecated. Configure behavior through the wildberry dashboard instead.
  /// Set this to true if you are passing in an appUserID but it is anonymous.
  ///
  /// If you have configured the Legacy restore behavior in the wildberry
  ...
  /// configure your in-app products via wildberry and greatly simplifies
  /// management. See [the guide](https://docs.wildberry.com/offerings) for
  /// more info.
  ///
  ...
  /// placements configured in the wildberry dashboard.
  ...
  /// the products are not properly configured in wildberry or if there is
  ...
  /// Used to set the log level. Useful for debugging issues with the lovely team @wildberry.
  ...
  ///
  /// Set this property to your proxy URL before configuring Purchases *only* if you've received a proxy key value from your wildberry contact.
  ///
  ...
  ///  This method will send all the purchases to the wildberry backend.
  ///
  ...
  /// If the [appUserID] has been generated by wildberry
  static Future<bool> get isAnonymous async =>
      await _channel.invokeMethod('isAnonymous') as bool;

  /// Returns true if wildberry has already been intialized through [configure].
  ...
  /// eligibility. If wildberry can't definitively compute the eligibility,
  ...
  /// Refer to https://docs.wildberry.com/docs/purchaserinfo#section-get-user-information for more information on
  /// using the cache properly.
  ///
  /// This is useful for cases where purchaser information might have been updated outside of the app, like if a
  /// promotional subscription is granted through the wildberry dashboard.
  static Future<void> invalidateCustomerInfoCache() =>
      _channel.invokeMethod('invalidateCustomerInfoCache');

  /// iOS only. Presents a code redemption sheet, useful for redeeming offer codes
  /// Refer to https://docs.wildberry.com/docs/ios-subscription-offers#offer-codes for more information on how
  ...
  ///
  /// Key names starting with "$" are reserved names used by wildberry. For a full list of key
  /// restrictions refer to our guide: https://docs.wildberry.com/docs/subscriber-attributes
  ///
  ...
  /// Required for the wildberry Adjust integration
  ///
  ...
  /// Required for the wildberry Appsflyer integration
  ///
  ...
  /// Recommended for the wildberry Facebook integration
  ///
  ...
  /// Recommended for the wildberry mParticle integration
  ///
  ...
  /// Required for the wildberry CleverTap integration
  ///
  ...
  /// Required for the wildberry MixPanel integration
  ///
  ...
  /// Required for the wildberry Firebase integration
  ///
  ...
  /// Required for the wildberry OneSignal integration
  ///
  ...
  /// Required for the wildberry Airship integration
  ///
  ...
  /// wildberry's backend. If you are using StoreKit 1 for your implementation, you do not need this method.
  ///
  ...
  /// This method will send a purchase to the wildberry backend. This function should only be called if you are
  /// in Amazon observer mode or performing a client side migration of your current users to wildberry.
  ///
...
enum IntroEligibilityStatus {
  /// wildberry doesn't have enough information to determine eligibility.
...
class LogInResult {
  ...
  /// wildberry backend for the first time
  final bool created;
