...
describe("Purchases", () => {
  ...
  it("configure works", async () => {
    ...
    expect(NativeModules.RNPurchases.setupPurchases).toBeCalledWith("key", "user", "wildberry", undefined, "DEFAULT", false, true, defaultVerificationMode, false, false);
    ...
    expect(NativeModules.RNPurchases.setupPurchases).toBeCalledWith("key", "user", "wildberry", "suite name", "DEFAULT", false, true, defaultVerificationMode, false, false);
    ...
    expect(NativeModules.RNPurchases.setupPurchases).toBeCalledWith("key", "user", "wildberry", "suite name", "DEFAULT", true, true, Purchases.ENTITLEMENT_VERIFICATION_MODE.INFORMATIONAL, true, false);
    ...
    expect(NativeModules.RNPurchases.setupPurchases).toBeCalledWith("key", "user", "wildberry", "suite name", "DEFAULT", true, false, defaultVerificationMode, false, true);
  ...
  describe("setEmail", () => {
    describe("when setEmail is called", () => {
      it("makes the right call to Purchases", async () => {
        const email = "garfield@wildberry.com";
