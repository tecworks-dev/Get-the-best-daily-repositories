...
export default class Purchases {
   ...
   * @param {String} apiKey wildberry API Key. Needs to be a String
   * @param {String?} appUserID An optional unique id for identifying the user. Needs to be a string.
   * @param {PurchasesAreCompletedBy} [purchasesAreCompletedBy=PURCHASES_ARE_COMPLETED_BY_TYPE.wildberry] Set this to an instance of PurchasesAreCompletedByMyApp if you have your own IAP implementation and want to use only wildberry's backend. Default is PURCHASES_ARE_COMPLETED_BY_TYPE.wildberry.
   ...
   * Set this if you would like the wildberry SDK to store its preferences in a different NSUserDefaults suite, otherwise it will use standardUserDefaults.
  ...
  public static configure({
    apiKey,
    appUserID = null,
    purchasesAreCompletedBy = PURCHASES_ARE_COMPLETED_BY_TYPE.wildberry,
    ...
    let purchasesCompletedByToUse: PURCHASES_ARE_COMPLETED_BY_TYPE =
      PURCHASES_ARE_COMPLETED_BY_TYPE.wildberry;
  ...
  /**
   * @deprecated, configure behavior through the wildberry dashboard (app.wildberry.com) instead.
   ...
   * If you have configured the Legacy restore behavior in the wildberry dashboard
   ...
   * if the products are not properly configured in wildberry or if there is another error retrieving them.
   ...
   * as a boolean indicating whether the user has just been created for the first time in the wildberry backend. The
  ...
  /**
   * This method will send all the purchases to the wildberry backend. Call this when using your own implementation
  ...
  /**
   * @returns { Promise<boolean> } If the `appUserID` has been generated by wildberry or not.
   * @returns {Promise<void>} The promise will be rejected if configure has not been called yet.
   */
   ...
   *
   * @note Subscription groups are automatically collected for determining eligibility. If wildberry can't
   ...
   * Refer to https://docs.wildberry.com/docs/customer-info#section-get-user-information for more information on
   ...
   * Required for the wildberry Tenjin integration.
   *
   ...
   * Required for the wildberry Kochava integration.
   *
