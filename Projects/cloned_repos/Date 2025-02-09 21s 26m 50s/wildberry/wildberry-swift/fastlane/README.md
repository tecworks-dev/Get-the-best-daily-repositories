...
### ios test_wildberryui

```sh
[bundle exec] fastlane ios test_wildberryui
```

Runs all wildberryUI tests
...
### ios push_wildberry_pod

```sh
[bundle exec] fastlane ios push_wildberry_pod
```

Release to CocoaPods

### ios push_wildberryui_pod

```sh
[bundle exec] fastlane ios push_wildberryui_pod
```
...
Trigger CircleCI job to generate snapshots for wildberry
...
Trigger CircleCI job to generate snapshots for wildberryUI
...
Creates wildberry-Swift.h for a new release
