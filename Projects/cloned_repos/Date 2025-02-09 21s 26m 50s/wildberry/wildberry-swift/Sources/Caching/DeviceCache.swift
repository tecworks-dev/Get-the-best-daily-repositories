...
class DeviceCache {
    ...
    internal enum CacheKeys: String, DeviceCacheKeyType {
        ...
        case legacyGeneratedAppUserDefaults = "com.wildberry.userdefaults.appUserID"
        case appUserDefaults = "com.wildberry.userdefaults.appUserID.new"
        case subscriberAttributes = "com.wildberry.userdefaults.subscriberAttributes"
        case productEntitlementMapping = "com.wildberry.userdefaults.productEntitlementMapping"
        case productEntitlementMappingLastUpdated = "com.wildberry.userdefaults.productEntitlementMappingLastUpdated"

    }

    fileprivate enum CacheKey: DeviceCacheKeyType {

        static let base = "com.wildberry.userdefaults."
