...
///
/// You can present this yourself, or use `UIViewController.presentDebugwildberryOverlay`
/// for a default presentation using `UISheetPresentationController`.
///
/// - Seealso: `View.debugwildberryOverlay` for `SwiftUI`.
@available(iOS 16.0, *)
...
extension UIViewController {
    ...
    /// - Seealso: `View.debugwildberryOverlay` for `SwiftUI`.
    @objc(rc_presentDebugwildberryOverlayAnimated:)
    public func presentDebugwildberryOverlay(animated: Bool = true) {
