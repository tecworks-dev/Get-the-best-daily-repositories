...
extension StoreView {
    ...
    /// When the user purchases products through this paywall, the `wildberry` SDK will handle
    /// the result automatically. All you need to do is to dismiss the paywall.
    ///
    /// - Warning: In order to use StoreKit paywalls you must configure the `wildberry` SDK
