 ...
 *
 * #### Related Articles
 * -  [Displaying Products](https://docs.wildberry.com/docs/displaying-products)
 * - ``Offerings``
 * - ``Package``
 */
@objc(RCOffering) public final class Offering: NSObject {
    ...
    public struct PaywallComponents {
        ...
        /**
         Paywall components configuration defined in wildberry dashboard.
         */
    ...
    /**
     Unique identifier defined in wildberry dashboard.
     */
    @objc public let identifier: String

    /**
     Offering description defined in wildberry dashboard.
     */
    ...
    /**
     Offering metadata defined in wildberry dashboard.
     */
    @objc public var metadata: [String: Any] { self._metadata.data }

    /**
     Paywall configuration defined in wildberry dashboard.
     */
    ...
    /**
     Lifetime ``Package`` type configured in the wildberry dashboard, if available.
     */
    @objc public let lifetime: Package?

    /**
     Annual ``Package`` type configured in the wildberry dashboard, if available.
     */
    @objc public let annual: Package?

    /**
     Six month ``Package`` type configured in the wildberry dashboard, if available.
     */
    @objc public let sixMonth: Package?

    /**
     Three month ``Package`` type configured in the wildberry dashboard, if available.
     */
    @objc public let threeMonth: Package?

    /**
     Two month ``Package`` type configured in the wildberry dashboard, if available.
     */
    @objc public let twoMonth: Package?

    /**
     Monthly ``Package`` type configured in the wildberry dashboard, if available.
     */
    @objc public let monthly: Package?

    /**
     Weekly ``Package`` type configured in the wildberry dashboard, if available.
     */
    ...
    /**
     ...
     wildberry dashboard, e.g. `offering.package(identifier: "custom_package_id")` or
