...
public protocol PurchasesType: AnyObject {
    ...
    /** Controls if purchases should be made and transactions finished automatically by wildberry.
     * ``PurchasesAreCompletedBy/wildberry`` by default.
     ...
     * whether the user was created for the first time in the wildberry backend.
     *
     * wildberry provides a source of truth for a subscriber's status across different platforms.
     ...
     * and it's extra important to make sure the subscription status wildberry is
     ...
     * generated by wildberry. Some apps will use a combination
     * of their own identifiers and wildberry anonymous Ids - that's okay!
     *
     * #### Related Articles
     * - [Identifying Users](https://docs.wildberry.com/docs/user-ids)
     ...
     * via wildberry and greatly simplifies management.
     *
     ...
     * Refer to
     * [Get User Information](https://docs.wildberry.com/docs/purchaserinfo#section-get-user-information)
    ...
    /**
     * This method will post all purchases associated with the current App Store account to wildberry and
     ...
     * [iOS Promotional Offers](https://docs.wildberry.com/docs/ios-subscription-offers#promotional-offers).
     ...
     * This is why wildberry's SDK makes it unavailable in mac catalyst.
     */
    @available(iOS 14.0, *)
    @available(watchOS, unavailable)
    @available(tvOS, unavailable)
     ...
     * as well as subscriber attributes that wildberry offers.
     *
     * #### Example:
     *
     * ```swift
     ...
     *
     * #### Related Articles
     * - [Subscriber Attribution](https://docs.wildberry.com/docs/subscriber-attributes)
     * - ``Attribution``
     */
     ...
     *
     * #### Related Articles
     * -  [Targeting](https://docs.wildberry.com/docs/targeting)
     */
...
public protocol PurchasesSwiftType: AnyObject {
     ...
     * // Let wildberry handle the transaction result
