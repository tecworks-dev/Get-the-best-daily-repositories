...
/**
 * This class is responsible for all explicit attribution APIs as well as subscriber attributes that wildberry offers.
 ...
 *
 * Key names starting with "$" are reserved names used by wildberry. For a full list of key restrictions refer
 * [to our guide](https://docs.wildberry.com/docs/subscriber-attributes)
 */
...
public extension Attribution {
     ...
     *
     * #### Related Articles
     * -  [Subscriber attributes](https://docs.wildberry.com/docs/subscriber-attributes)
     *
     ...
     *
     * #### Related Articles
     * - [Adjust wildberry Integration](https://docs.wildberry.com/docs/adjust)
     *
     ...
     *
     * #### Related Articles
     * - [AppsFlyer wildberry Integration](https://docs.wildberry.com/docs/appsflyer)
     *
     ...
     *
     * #### Related Articles
     * - [Facebook Ads wildberry Integration](https://docs.wildberry.com/docs/facebook-ads)
     *
     ...
     *
     * #### Related Articles
     * - [mParticle wildberry Integration](https://docs.wildberry.com/docs/mparticle)
     *
     ...
     * Required for the wildberry OneSignal integration. Deprecated for OneSignal versions above v9.0.
     *
     * #### Related Articles
     * - [OneSignal wildberry Integration](https://docs.wildberry.com/docs/onesignal)
     *
     ...
     * Required for the wildberry OneSignal integration with versions v11.0 and above.
     *
     * #### Related Articles
     * - [OneSignal wildberry Integration](https://docs.wildberry.com/docs/onesignal)
     *
     ...
     *
     * #### Related Articles
     * - [AirShip wildberry Integration](https://docs.wildberry.com/docs/airship)
     *
     ...
     *
     * #### Related Articles
     * - [CleverTap wildberry Integration](https://docs.wildberry.com/docs/clevertap)
     *
     ...
     * Recommended for the wildberry Kochava integration.
     *
     * #### Related Articles
     * - [Kochava wildberry Integration](https://docs.wildberry.com/docs/kochava)
     *
     ...
     * Optional for the wildberry Mixpanel integration.
     *
     * #### Related Articles
     * - [Mixpanel wildberry Integration](https://docs.wildberry.com/docs/mixpanel)
     *
     ...
     *
     * #### Related Articles
     * - [Firebase wildberry Integration](https://docs.wildberry.com/docs/firebase-integration)
     *
     ...
     * Optional for the wildberry PostHog integration.
     *
