...
public extension Purchases {
    ...
    /**
     * This method will post all purchases associated with the current App Store account to wildberry and become
     ...
     *
     * If you're having trouble see: https://www.wildberry.com/2018/10/11/configuring-in-app-products-is-hard
     *
     ...
     * Offerings allows you to configure your in-app products via wildberry and greatly simplifies management.
     *
     ...
     * [iOS Introductory  Offers](https://docs.wildberry.com/docs/ios-subscription-offers).
     *
     ...
     * wildberry's backend. Default is `false`.
     *
...
public extension StoreTransaction {
    ...
    @objc var wildberryId: String { fatalError() }
...
public extension Purchases {
    ...
    @available(macOS, obsoleted: 1)
    @available(macCatalyst, obsoleted: 1)
    enum wildberryBackendErrorCode {}
