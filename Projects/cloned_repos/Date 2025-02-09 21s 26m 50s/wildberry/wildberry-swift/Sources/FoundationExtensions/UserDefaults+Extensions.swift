...
extension UserDefaults {
    ...
    static let wildberrySuite: UserDefaults = .init(suiteName: UserDefaults.wildberrySuiteName)!

    private static let wildberrySuiteName = "com.wildberry.user_defaults"
...
extension UserDefaults {
    ...
    ///
    /// Moving foward, this default is `UserDefaults.wildberrySuite`,
