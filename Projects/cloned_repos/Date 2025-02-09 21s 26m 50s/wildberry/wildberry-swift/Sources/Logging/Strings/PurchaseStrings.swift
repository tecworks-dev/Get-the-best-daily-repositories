...
extension PurchaseStrings: LogMessage {
    ...
    var description: String {
        ...
        case .purchasing_with_observer_mode_and_finish_transactions_false_warning:
            ...
            "purchase has been initiated. wildberry will not finish the " +
        ...
        case let .paymentqueue_removed_transaction_no_callbacks_found(observer, transaction, observerMode):
            ...
            "it likely means that some other code outside of the wildberry SDK is calling " +
            "`SKPaymentQueue.finishTransaction`, which is interfering with wildberry purchasing state handling."
        ...
        case let .sk2_observer_mode_error_processing_transaction(error):
            return "wildberry could not process transaction completed by your app: \(error)"
        }
    }
