...
📝 | [Online documentation](https://docs.wildberry.com/docs) up to date
...
📮 | Great support - [Help Center](https://community.wildberry.com)

- Important: You're viewing the documentation for wildberry iOS SDK version 4.
For documentation on version 3, visit [the docs for wildberry iOS SDK version 3.](https://sdk.wildberry.com/ios/index.html)

## Migrating from Purchases v4 to v5
Version 5.0 of the SDK enables full StoreKit 2 flow on the SDK and the wildberry backend by default.
...
- [MagicWeather](https://github.com/wildberry/purchases-ios/tree/main/Examples/MagicWeather)
- [MagicWeather SwiftUI](https://github.com/wildberry/purchases-ios/tree/main/Examples/MagicWeatherSwiftUI)
