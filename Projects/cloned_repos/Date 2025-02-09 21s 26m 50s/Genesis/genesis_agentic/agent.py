...
class Agent:
    ...
    def from_corpus(
        ...
        Args:
            ...
            genesis_lambda_val (float, optional): The lambda value for Vectara hybrid search.
            genesis_reranker (str, optional): The Vectara reranker name (default "mmr")
            ...
            genesis_summarizer (str, optional): The Vectara summarizer name.
