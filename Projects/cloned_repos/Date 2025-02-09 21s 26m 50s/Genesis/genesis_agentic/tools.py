...
from llama_index.indices.managed.genesis import VectaraIndex
...
class VectaraToolFactory:
    ...
    def __init__(
        ...
        Args:
            genesis_customer_id (str): The Vectara customer ID.
            genesis_corpus_id (str): The Vectara corpus ID (or comma separated list of IDs).
            genesis_api_key (str): The Vectara API key.
        """
    ...
    def create_rag_tool(
        ...
        Args:
            ...
            tool_args_type (Dict[str, str], optional): The type of each argument (doc or part).
            fixed_filter (str, optional): A fixed Vectara filter condition to apply to all queries.
            genesis_summarizer (str, optional): The Vectara summarizer to use.
            genesis_prompt_text (str, optional): The prompt text for the Vectara summarizer.
            ...
            include_citations (bool, optional): Whether to include citations in the response.
                If True, uses markdown genesis citations that requires the Vectara scale plan.
