#!/bin/env python
#
# Copyright (C) 2018, astra Labs, All rights reserved.
...
from astracommon import node_runner, constants
...
from astracommon.utils import cli, convert, config, ip_resolver
from astracommon.models.node_type import NodeType

from astrautils import logging_messages_utils

from astragateway import btc_constants, gateway_constants, ont_constants
from astragateway.connections.gateway_node_factory import get_gateway_node_type
...
from astragateway import argument_parsers
from astragateway.utils.gateway_start_args import GatewayStartArgs
from astragateway import gateway_init_tasks

MAX_NUM_CONN = 8192
PID_FILE_NAME = "astragateway.pid"
...
def get_argument_parser() -> argparse.ArgumentParser:
    ...
    arg_parser = argparse.ArgumentParser(parents=[cli.get_argument_parser()],
                                         description="Command line interface for the astra Gateway.",
                                         usage="astra_gateway --blockchain-protocol [PROTOCOL] [additional "
                                               "arguments]")
    ...
    arg_parser.add_argument("--connect-to-remote-blockchain",
                            help="If gateway should proxy messages from a remote astra owned blockchain node",
    ...
    arg_parser.add_argument("--remote-public-key",
                            help="Public key of remote astra owned Ethereum node for encrypted communication "
    ...
    arg_parser.add_argument(
        ...
        default="/app/astragateway/debug/compressed-short-ids",
    )
    arg_parser.add_argument(
...
def main() -> None:
    ...
    logger_names.append("astragateway")
