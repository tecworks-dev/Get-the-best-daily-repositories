...
from astracommon.exceptions import ChecksumError
...
from astragateway import ont_constants, gateway_constants
...
from astragateway.messages.ont.inventory_ont_message import InventoryOntType
from astragateway.services.abstract_block_queuing_service import (
...
class OntBlockQueuingService(
    ...
    # pyre-fixme[14]: `astragateway.services.ont.ont_block_queuing_service.OntBlockQueuingService.push`
    ...
    #  overridden parameter `Optional[Variable[astragateway.services.abstract_block_queuing_service.TBlockMessage
    #  (bound to astracommon.messages.abstract_block_message.AbstractBlockMessage)]]`.
    def push(
        self,
        ...
        #  assertion `not isinstance(block_msg, astragateway.messages.ont.consensus_ont_message.OntConsensusMessage)`
        #  will always fail.
    ...
    # pyre-fixme[14]: `astragateway.services.ont.ont_block_queuing_service.OntBlockQueuingService.send_block_to_node`
    ...
    #  `Optional[Variable[astragateway.services.abstract_block_queuing_service.TBlockMessage
    #  (bound to astracommon.messages.abstract_block_message.AbstractBlockMessage)]]`.
    ...
    # pyre-fixme[14]: `astragateway.services.ont.ont_block_queuing_service.OntBlockQueuingService.mark_block_seen_by_
    ...
    #  parameter `Optional[Variable[astragateway.services.abstract_block_queuing_service.TBlockMessage
    #  (bound to astracommon.messages.abstract_block_message.AbstractBlockMessage)]]`.
