...
from astragateway.messages.btc.abstract_btc_message_converter import CompactBlockCompressionResult
...
from astragateway.messages.btc.inventory_btc_message import GetDataBtcMessage, InventoryType
...
class BtcBlockProcessingService(BlockProcessingService):
    ...
    def process_compact_block(
        ...
        parse_result = self._node.message_converter.compact_block_to_astra_block(  # pyre-ignore
            block_message,
    ...
    def process_compact_block_recovery(
        ...
        try:
            recovery_result = self._node.message_converter.recovered_compact_block_to_astra_block(  # pyre-ignore
                failure_result
            )
