from astrautils.logging_messages_utils import LogMessage
from astrautils.log_message_categories import REQUEST_RESPONSE_CATEGORY, CONNECTION_PROBLEM_CATEGORY, \
...
BLOCK_RECOVERY_NEEDED = LogMessage(
    "G-000011",
    GENERAL_CATEGORY,
    "Block recovery needed. Missing {} sids, {} tx hashes. Total txs in astra_block: {}"
)
...
BLOCK_RECOVERY_NEEDED_ONT_CONSENSUS = LogMessage(
    "G-000051",
    GENERAL_CATEGORY,
    "Consensus block recovery needed. Missing {} sids, {} tx hashes. Total txs in astra_block: {}"
)
