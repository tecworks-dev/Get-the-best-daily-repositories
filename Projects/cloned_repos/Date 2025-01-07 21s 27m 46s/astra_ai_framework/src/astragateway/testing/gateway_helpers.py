...
from astracommon.test_utils.helpers import COOKIE_FILE_PATH, get_common_opts, \
    ...
    **kwargs,
    ...
    if blockchain_peers is not None:
        ...
        for peer in blockchain_peers.split(","):
            blockchain_peer = argument_parsers.parse_peer(blockchain_protocol, peer) # from astragateway import argument_parsers,
