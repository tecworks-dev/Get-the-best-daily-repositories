...
from astragateway.messages.ont import ont_normal_message_converter
...
class OntExtensionMessageConverter(AbstractOntMessageConverter):
    ...
    def astra_block_to_block(
        ...
        try:
            ...
            header_info = ont_normal_message_converter.parse_astra_block_header(astra_block_msg, deque())
