...
from astracommon.constants import UL_INT_SIZE_IN_BYTES
from astracommon.messages.abstract_block_message import AbstractBlockMessage
from astracommon.utils import crypto
from astracommon.utils.blockchain_utils.btc.btc_common_utils import btc_varint_to_int
from astracommon.utils.blockchain_utils.btc.btc_object_hash import BtcObjectHash
from astragateway.btc_constants import BTC_HDR_COMMON_OFF, BTC_BLOCK_HDR_SIZE, BTC_SHA_HASH_LEN, \
...
from astragateway.messages.btc.btc_messages_util import pack_int_to_btc_varint, get_next_tx_size, pack_block_header
