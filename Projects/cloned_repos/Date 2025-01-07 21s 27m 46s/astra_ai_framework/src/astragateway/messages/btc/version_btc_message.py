...
from astragateway.btc_constants import BTC_NODE_SERVICES, BTC_HDR_COMMON_OFF, BTC_IP_ADDR_PORT_SIZE
...
from astragateway.messages.btc.btc_messages_util import btcbytearray_to_ipaddrport, ipaddrport_to_btcbytearray
