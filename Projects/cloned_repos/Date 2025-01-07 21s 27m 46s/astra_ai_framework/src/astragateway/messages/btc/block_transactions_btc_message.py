...
from astragateway.btc_constants import BTC_HDR_COMMON_OFF, BTC_SHA_HASH_LEN, BTC_VARINT_MIN_SIZE
...
from astragateway.messages.btc.btc_messages_util import pack_int_to_btc_varint, get_next_tx_size
