...
from astracommon.messages.astra.version_message import VersionMessage
from astracommon.utils import uuid_pack
from astracommon.utils.stats import message_utils
