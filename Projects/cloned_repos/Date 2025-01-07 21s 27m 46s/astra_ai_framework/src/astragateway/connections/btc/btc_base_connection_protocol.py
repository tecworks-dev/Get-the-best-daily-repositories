...
from astragateway.messages.btc.inventory_btc_message import InvBtcMessage, InventoryType
...
class BtcBaseConnectionProtocol(AbstractBlockchainConnectionProtocol):
    def __init__(self, connection):
        ...
        self.node = typing.cast("astragateway.connections.btc.btc_gateway_node.BtcGatewayNode", connection.node)
