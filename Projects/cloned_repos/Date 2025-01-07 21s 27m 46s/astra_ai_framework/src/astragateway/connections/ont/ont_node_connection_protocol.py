...
from astragateway.connections.ont.ont_base_connection_protocol import OntBaseConnectionProtocol
...
class OntNodeConnectionProtocol(OntBaseConnectionProtocol):
    ...
    def msg_consensus(self, msg: OntConsensusMessage):
        ...
        try:
            astra_block, block_info = self.node.consensus_message_converter.block_to_astra_block(
                msg,
        ...
        self.node.block_processing_service._process_and_broadcast_compressed_block(
            astra_block, self.connection, block_info, block_hash
        )
