...
from astracommon.connections.internal_node_connection import InternalNodeConnection
from astracommon.feed.feed import FeedKey
from astracommon.messages.astra.abstract_cleanup_message import AbstractCleanupMessage
from astracommon.messages.astra.bdn_performance_stats_message import BdnPerformanceStatsMessage
from astracommon.messages.astra.blockchain_network_message import RefreshBlockchainNetworkMessage
from astracommon.messages.astra.astra_message_type import BloxrouteMessageType
from astracommon.messages.astra.astra_message_validator import BloxrouteMessageValidator
from astracommon.messages.astra.compressed_block_txs_message import CompressedBlockTxsMessage
from astracommon.messages.astra.disconnect_relay_peer_message import DisconnectRelayPeerMessage
from astracommon.messages.astra.hello_message import HelloMessage
from astracommon.messages.astra.notification_message import NotificationMessage
from astracommon.messages.astra.txs_message import TxsMessage
from astracommon.messages.validation.message_size_validation_settings import MessageSizeValidationSettings
from astracommon.models.entity_type_model import EntityType
from astracommon.models.notification_code import NotificationCode
...
from astracommon.utils import convert, performance_utils
from astracommon.utils import memory_utils
from astracommon.utils.alarm_queue import AlarmId
from astracommon.utils.object_hash import Sha256Hash
from astracommon.utils.stats import hooks, stats_format
...
from astracommon.utils.stats.transaction_stat_event_type import TransactionStatEventType
from astracommon.utils.stats.transaction_statistics_service import tx_stats
from astragateway import log_messages, gateway_constants
from astracommon.feed.new_transaction_feed import NewTransactionFeed, RawTransactionFeedEntry
from astragateway.services.block_recovery_service import RecoveredTxsSource
from astragateway.services.gateway_transaction_service import MissingTransactions
from astragateway.utils.logging.status import status_log
...
from astrautils.logging import LogRecordType
...
class AbstractRelayConnection(InternalNodeConnection["AbstractGatewayNode"]):
    ...
    def msg_broadcast(self, msg):
        """
        Handle broadcast message receive from astra.
    ...
    def msg_key(self, msg):
        """
        Handles key message receive from astra.
    ...
    def msg_tx(self, msg):
        """
        Handle transactions receive from astra network.
        """
        ...
        if processing_result.set_content:
            ...
            if self.node.has_active_blockchain_peer():
                blockchain_tx_message = self.node.message_converter.astra_tx_to_tx(msg)
