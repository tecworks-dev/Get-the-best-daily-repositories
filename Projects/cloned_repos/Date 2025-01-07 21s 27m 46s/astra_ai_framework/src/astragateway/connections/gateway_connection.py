...
from astragateway.messages.gateway.gateway_version_manager import gateway_version_manager
...
class GatewayConnection(InternalNodeConnection["AbstractGatewayNode"]):
    ...
    def msg_block_propagation_request(self, msg):
        ...
        self.node.neutrality_service.propagate_block_to_network(astra_block, self, from_peer=True)
