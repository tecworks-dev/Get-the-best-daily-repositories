...
from astracommon.messages.astra import protocol_version
...
from astracommon.messages.astra.notification_message import NotificationMessage, NotificationCode
...
class AbstractRelayConnectionTest(AbstractTestCase):
    ...
    @patch("astragateway.services.block_processing_service.BlockProcessingService._handle_decrypted_block")
    ...
    @patch("astragateway.connections.abstract_relay_connection.AbstractRelayConnection.log")
