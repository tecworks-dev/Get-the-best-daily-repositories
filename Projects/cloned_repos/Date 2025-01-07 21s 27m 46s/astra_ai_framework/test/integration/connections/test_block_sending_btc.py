...
from astragateway.messages.btc.inventory_btc_message import InvBtcMessage
from astragateway.messages.gateway.block_received_message import BlockReceivedMessage
from astragateway.testing.abstract_btc_gateway_integration_test import AbstractBtcGatewayIntegrationTest
from astragateway.testing.mocks.mock_btc_messages import btc_block, RealBtcBlocks


@patch("astracommon.constants.OUTPUT_BUFFER_MIN_SIZE", 0)
@patch("astracommon.constants.OUTPUT_BUFFER_BATCH_MAX_HOLD_TIME", 0)
@patch("astragateway.gateway_constants.NEUTRALITY_EXPECTED_RECEIPT_COUNT", 1)
