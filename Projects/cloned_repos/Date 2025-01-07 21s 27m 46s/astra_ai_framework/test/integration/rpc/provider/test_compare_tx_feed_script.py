...
from astracommon.feed.new_transaction_feed import FeedSource
...
from astra_cli import compare_tx_feeds
...
def generate_new_eth_transaction() -> TxMessage:
    ...
    tx_message = EthNormalMessageConverter().tx_to_astra_txs(transactions_eth_message, 5)[0][0]
    return tx_message
...
class CompareTxFeedScriptTest(AbstractTestCase):
    ...
    @async_test(3)
    @patch("astra_cli.compare_tx_feeds.stats", verify_compare_tx_feed_script_results)
    ...
    @async_test(3)
    @patch("astra_cli.compare_tx_feeds.stats", verify_compare_tx_feed_script_results_exclude_duplicates)
    ...
    @async_test(3)
    @patch("astra_cli.compare_tx_feeds.stats", verify_compare_tx_feed_script_results_exclude_from_blockchain)
