...
class AbstractAutoencoder(pl.LightningModule):
    ...
    def apply_ckpt(self, ckpt: Union[None, str, dict]):
        ...
        if isinstance(ckpt, str):
            ckpt = {
                "target": "gen_ai.sgm.modules.checkpoint.CheckpointEngine",
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            encoder_config={
                "target": "gen_ai.sgm.modules.diffusionmodules.model.Encoder",
                "params": ddconfig,
            },
            decoder_config={
                "target": "gen_ai.sgm.modules.diffusionmodules.model.Decoder",
                "params": ddconfig,
            },
            **kwargs,
        )
...
class AutoencoderKL(AutoencodingEngineLegacy):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "gen_ai.sgm.modules.autoencoding.regularizers"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "gen_ai.sgm.modules.autoencoding.regularizers.quantize" ".VectorQuantizer"
                ),
                "params": {
                    "n_e": n_embed,
                    "e_dim": embed_dim,
