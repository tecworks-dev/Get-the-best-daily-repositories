...
class ViewSamplerBounded(ViewSampler[ViewSamplerBoundedCfg]):
    ...
    def sample(
        ...
        if self.stage == "test":
            ...
            pick_start = index_context_left + self.cfg.min_distance_to_context_views
            pick_end = index_context_right + 1 - self.cfg.min_distance_to_context_views
