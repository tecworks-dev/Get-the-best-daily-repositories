...
class QEDJourney(ThreeDScene):
    def construct(self):
        ...
        # Adjust camera orientation to look more directly at text elements
        ...
        self.add_fixed_in_frame_mobjects(maxwell_eq)  # Keep equations facing viewer
        ...
        ).scale(0.8).to_corner(UR)  # Keep equations facing viewer
