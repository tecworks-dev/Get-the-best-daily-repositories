...
- The template file should contain a list of transformations and operations to apply
  to the input data. The template file should be in JSON format.
    - See `docs/template.json` ([link](https://github.com/silverselli/ptt/blob/main/docs/template.json)) for an example.
    - See `templates/` ([link](https://github.com/silverselli/ptt/blob/main/templates/)) for more examples.
