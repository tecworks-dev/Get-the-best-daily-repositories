...
```bash
doc-builder build prime docs/source/en/ --build_dir ~/tmp/test-build
```
...
```bash
doc-builder preview prime docs/source/en/
```
...
the filename without the extension in the [`_toctree.yml`](https://github.com/huggingface/prime/blob/main/docs/source/_toctree.yml) file.
...
The `huggingface/prime` documentation follows the
...
When translating, refer to the guide at [./TRANSLATING.md](https://github.com/huggingface/prime/blob/main/docs/TRANSLATING.md).
