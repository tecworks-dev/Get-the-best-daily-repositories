...
update_app_version_in_helm_charts ".github/helm/swox/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/swox/charts/graphql/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/swox/charts/sync/Chart.yaml" "$new_version"
