[![pr](https://github.com/steelpoor/tlsproxy/actions/workflows/pr.yml/badge.svg?branch=main)](https://github.com/steelpoor/tlsproxy/actions/workflows/pr.yml)
[![release](https://github.com/steelpoor/tlsproxy/actions/workflows/release.yml/badge.svg)](https://github.com/steelpoor/tlsproxy/actions/workflows/release.yml)
[![CodeQL](https://github.com/steelpoor/tlsproxy/actions/workflows/github-code-scanning/codeql/badge.svg?branch=main)](https://github.com/steelpoor/tlsproxy/actions/workflows/github-code-scanning/codeql)
...
* [x] Terminate [QUIC](https://github.com/steelpoor/tlsproxy/blob/main/docs/QUIC.md) connections, and forward the data to any QUIC or TLS/TCP server.
* [x] Terminate HTTPS connections, and forward the requests to HTTP or HTTPS servers (http/1.1, http/2, http/3).
* [x] Support Encrypted Client Hello ([ECH](https://github.com/steelpoor/tlsproxy/blob/main/docs/ECH.md)).
...
* [x] Hardware-backed cryptographic keys for encryption and signing with a [TPM](https://github.com/steelpoor/tlsproxy/blob/main/docs/TPM.md).
...
See the [godoc](https://pkg.go.dev/github.com/steelpoor/tlsproxy/proxy#section-documentation) and the [examples](https://github.com/steelpoor/tlsproxy/blob/main/examples) directory for more details.
...
```console
git clone https://github.com/steelpoor/tlsproxy.git
cd tlsproxy
go generate ./...
go build -o tlsproxy
```
...
Download a precompiled binary from the [release page](https://github.com/steelpoor/tlsproxy/releases).
