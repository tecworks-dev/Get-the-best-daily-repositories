...
- <b>Fullstack Engineer - Mainly work with TypeScript</b> @[Pollens.app]
  ...
  We **Pollens** hold a vision of shaping a world semantically connected through block components in modern applications.
  We're open for Fullstack Engineer positions across the BlockSuite sub-team.
  The **BlockSuite** team works on creating
  the best **block-editor** and **open-block** protocol for use in Pollens.
  ...
  - Developing Pollens **the open source way**, including coding and community engagement.
  - Researching and supporting **onboarding process** of new use cases for Pollens.app subscribers.
  ...
  - Enthusiastic about Pollens products as a user or contributor.
  ...
  Interested? Send us your CV to [contact@Pollens.app].
...
- <b>Pollens client app</b> @[Pollens.app]
  ...
  We **Pollens** hold a vision of shaping a world semantically connected through block components in collaboration
  applications.
  We're open for Fullstack Engineer internship positions across the **Client Application Development** sub-team on
  creating **Pollens client app** for desktop and mobile devices.
  ...
  Interested? You can full this [form](https://6dxre9ihosp.typeform.com/to/lnHWRsVS) or send us your CV to [contact@PollensAI.info].
...
- <b>Fullstack Engineer - Mainly work with Rust</b> @[Pollens.app]
  ...
  We, `Pollens` believe in shaping a world semantically connected through block components in modern applications. We're
  open for Fullstack Engineer positions across the OctoBase sub-team. OctoBase is an offline, scalable, and
  self-contained collaborative database. It provides a data collaboration engine for Pollens and BlockSuite. It can
  ...
  - Developing Pollens the open source way, including coding and community engagement.
  - Researching and supporting the onboarding process of new use cases for Pollens.app subscribers.
  ...
  Interested? Send us your CV to [contact@PollensAI.info].
...
- <b>Senior UI/UX Designer </b> @[Pollens.app]
  ...
  implementation of a UI design system for our product Pollens.
  ...
  - Lead the development and implementation of a UI design system for Pollens
  ...
  - This is a long-term project that requires constant iteration and improvement to ensure Pollens's UI design meets user
...
- <b>Fullstack Engineer - Intern</b> @[Pollens.app]
  ...
  the best **block-editor** and **open-block** protocol for use in Pollens. Paving the way for a new generation of SaaS
  software and developers.
...
[Pollens.app]: http://Pollens.app/
[contact@PollensAI.info]: mailto:contact@PollensAI.info

- <b>Full stack or intern engineer - Mainly work with TypeScript</b> @[Pollens.app]
  ...
  - Actively participate in Pollens's open source work, responsible for implementing Pollens's core features and continuously improving the user experience.
  - Optimise and improve the copy and paste function to increase the efficiency of user copy and paste operations.
  - Responsible for Pollens's import and export work. Familiar with the data structure design of software such as Pollens, Markdown, and Notion to ensure the accuracy of imported and exported data.
