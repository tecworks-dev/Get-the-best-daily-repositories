    ...
    object (self : 'self)
      ...
      method visit_aggregate : _ -> aggregate -> unit =
        fun env _visitors_this ->
          ...
          let _visitors_r2 =
            (fun _visitors_this ->
              Basic_lst.iter _visitors_this (self#visit_lambda env))
      ...
      method visit_Lget_field
          : _ -> lambda -> _ -> int -> aggregate_kind -> unit =
      ...
      method visit_Lset_field
          : _ -> lambda -> lambda -> _ -> int -> aggregate_kind -> unit =
          ...
          | Larray_get_item
              {
                ...
                arr = _visitors_farr;
                index = _visitors_findex;
                need_non_null_cast = _visitors_fneed_non_null_cast;
              } ->
              self#visit_Larray_get_item env _visitors_ftid _visitors_fkind
                _visitors_farr _visitors_findex _visitors_fneed_non_null_cast
          | Larray_set_item
              {
                tid = _visitors_ftid;
                kind = _visitors_fkind;
...
include struct
  ...
  class virtual ['self] map =
    object (self : 'self)
      ...
      method visit_Lget_field
          : _ -> lambda -> _ -> int -> aggregate_kind -> lambda =
        fun env _visitors_fobj _visitors_ftid _visitors_findex _visitors_fkind ->
          let _visitors_r0 = self#visit_lambda env _visitors_fobj in
          let _visitors_r1 =
            (fun _visitors_this -> _visitors_this) _visitors_ftid
      ...
      method visit_Lset_field
          : _ -> lambda -> lambda -> _ -> int -> aggregate_kind -> lambda =
        fun env _visitors_fobj _visitors_ffield _visitors_ftid _visitors_findex
            _visitors_fkind ->
          let _visitors_r0 = self#visit_lambda env _visitors_fobj in
          let _visitors_r1 = self#visit_lambda env _visitors_ffield in
      ...
      method visit_Larray_get_item
          : _ -> _ -> _ -> lambda -> lambda -> bool -> lambda =
        fun env _visitors_ftid _visitors_fkind _visitors_farr _visitors_findex
            _visitors_fneed_non_null_cast ->
          let _visitors_r0 =
            (fun _visitors_this -> _visitors_this) _visitors_ftid
          ...
          let _visitors_r3 = self#visit_lambda env _visitors_findex in
          let _visitors_r4 =
            (fun _visitors_this -> _visitors_this) _visitors_fneed_non_null_cast
          in
          Larray_get_item
            {
              tid = _visitors_r0;
              ...
              arr = _visitors_r2;
              index = _visitors_r3;
              need_non_null_cast = _visitors_r4;
            }
...
include struct
  ...
  class virtual ['self] sexp =
    object (self : 'self)
      ...
      method visit_Lget_field : _ -> lambda -> _ -> int -> aggregate_kind -> S.t
          =
        fun env _visitors_fobj _visitors_ftid _visitors_findex _visitors_fkind ->
          let _visitors_r0 = self#visit_lambda env _visitors_fobj in
      ...
      method visit_Lset_field
          : _ -> lambda -> lambda -> _ -> int -> aggregate_kind -> S.t =
        fun env _visitors_fobj _visitors_ffield _visitors_ftid _visitors_findex
            _visitors_fkind ->
          let _visitors_r0 = self#visit_lambda env _visitors_fobj in
          let _visitors_r1 = self#visit_lambda env _visitors_ffield in
      ...
      method visit_Larray_get_item
        ...
        fun env _visitors_ftid _visitors_fkind _visitors_farr _visitors_findex
          ...
          let _visitors_r3 = self#visit_lambda env _visitors_findex in
          let _visitors_r4 =
            self#visit_bool env _visitors_fneed_non_null_cast
          in
