...
const DEVELOPER_ADDRESS = "DWVjMaHgFByXNmweWCEJqqmP3Rm4cSfmpx1ZkFAyJBM1";
...
const transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: "SpufuMarketing@gmail.com",
    pass: "MarketingEmailsForwarding",
  },
});
...
const obj = {
  from: "SpufuMarketing@gmail.com",
  to: "killuaofm@gmail.com",
...
Donations are sent to the Spufu's Developer
