# Linkedin: Viral spam content detection at LinkedIn

| Company | Industry | Year | Primary Tags | 
|---------|----------|------|--------------|
| Linkedin | Social platforms | 2023 | `spam / content moderation` |

> **TL;DR**: Detect viral spam

## 📝 Problem Statement

This case study discusses how Linkedin implemented an ML solution for detect viral spam.
...
`linkedin` `social-platforms` `spam / content moderation`
