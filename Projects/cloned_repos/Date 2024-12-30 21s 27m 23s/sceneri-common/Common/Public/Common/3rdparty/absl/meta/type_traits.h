...
#pragma warning(pop)
		...
		struct IsTriviallyMoveConstructibleObject
			: std::integral_constant<
					bool,
					std::is_move_constructible<type_traits_internal::SingleMemberUnion<T>>::value && absl::is_trivially_destructible<T>::value>
		{
		};
		...
		struct IsTriviallyCopyConstructibleObject
			: std::integral_constant<
					bool,
					std::is_copy_constructible<type_traits_internal::SingleMemberUnion<T>>::value && absl::is_trivially_destructible<T>::value>
		{
		};
...
// std forms now appear to be compliant.
	...
	private:
		...
		static_assert(
			compliant || std::is_trivially_destructible<T>::value,
	...
	struct is_trivially_default_constructible
		: std::integral_constant<
				bool,
				__has_trivial_constructor(T) && std::is_default_constructible<T>::value && is_trivially_destructible<T>::value>
	{
	...
	private:
		...
		static_assert(
			compliant || std::is_trivially_default_constructible<T>::value,
	...
	template<typename T>
	struct is_trivially_move_constructible : std::conditional<
	...
	private:
		...
		static_assert(
			compliant || std::is_trivially_move_constructible<T>::value,
	...
	// expression to be nontrivial.
	template<typename T>
	struct is_trivially_copy_constructible : std::conditional<
																						 std::is_object<T>::value && !std::is_array<T>::value,
	...
	private:
		...
		static_assert(
			compliant || std::is_trivially_copy_constructible<T>::value,
	...
	template<typename T>
	struct is_trivially_move_assignable : std::conditional<
																					std::is_object<T>::value && !std::is_array<T>::value && std::is_move_assignable<T>::value,
																					std::is_move_assignable<type_traits_internal::SingleMemberUnion<T>>,
																					type_traits_internal::IsTriviallyMoveAssignableReference<T>>::type::type
	{
#ifdef ABSL_HAVE_STD_IS_TRIVIALLY_ASSIGNABLE
	private:
		static constexpr bool compliant = std::is_trivially_move_assignable<T>::value == is_trivially_move_assignable::value;
		static_assert(
			compliant || std::is_trivially_move_assignable<T>::value,
	...
	private:
		...
		static_assert(
			compliant || std::is_trivially_copy_assignable<T>::value,
	...
	namespace type_traits_internal
	{
		...
		class is_trivially_copyable_impl
		{
			...
			static constexpr bool kIsCopyOrMoveConstructible = std::is_copy_constructible<ExtentsRemoved>::value ||
			                                                   std::is_move_constructible<ExtentsRemoved>::value;
			static constexpr bool kIsCopyOrMoveAssignable = absl::is_copy_assignable<ExtentsRemoved>::value ||
...
#define ABSL_META_INTERNAL_STD_HASH_SFINAE_FRIENDLY_ 1
		...
		struct IsHashable<
			Key,
			absl::enable_if_t<std::is_convertible<decltype(std::declval<std::hash<Key>&>()(std::declval<Key const &>())), std::size_t>::value>>
			: std::true_type
		{
		};
