...
#if defined(ABSL_HAVE_INTRINSIC_INT128)
#include "Common/3rdparty/absl/numeric/int128_have_intrinsic.inc"  // IWYU pragma: export
#else  // ABSL_HAVE_INTRINSIC_INT128
#include "Common/3rdparty/absl/numeric/int128_no_intrinsic.inc"  // IWYU pragma: export
#endif  // ABSL_HAVE_INTRINSIC_INT128
