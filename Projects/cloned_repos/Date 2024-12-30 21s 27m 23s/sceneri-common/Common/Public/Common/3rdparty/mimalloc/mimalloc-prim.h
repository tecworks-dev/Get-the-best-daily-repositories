...
typedef struct mi_os_mem_config_s
{
	...
	bool has_virtual_reserve; // supports virtual address space reservation? (if true we can reserve virtual address space without using
...
// other possible unused ones are 9, 29, __PTK_FRAMEWORK_JAVASCRIPTCORE_KEY4 (94), __PTK_FRAMEWORK_GC_KEY9 (112) and
// __PTK_FRAMEWORK_OLDGC_KEY9 (89) see <https://github.com/rweichler/substrate/blob/master/include/pthread_machdep.h>
...
{
	mi_heap_t* heap =
		(mi_unlikely(_mi_heap_default_key == (pthread_key_t)(-1)) ? _mi_heap_main_get() : (mi_heap_t*)pthread_getspecific(_mi_heap_default_key)
	  );
